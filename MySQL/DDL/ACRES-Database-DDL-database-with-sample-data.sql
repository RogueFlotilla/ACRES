...
espionage.");
INSERT INTO APT_GROUPS VALUES("APT28", "Fancy Bear", "APT28 is a Russian threat group 
linked to GRU military intelligence, known for spear-phishing campaigns targeting NATO, 
governments, and political institutions, with custom malware like X-Agent.");
INSERT INTO APT_GROUPS VALUES("APT29", "Cozy Bear", "APT29 is a Russian group associated 
with the Foreign Intelligence Service (SVR). Known for targeting government and research 
organizations, APT29 uses advanced living-off-the-land techniques and custom malware like 
CloudDuke.");
INSERT INTO APT_GROUPS VALUES("APT3", "Gothic Panda", "APT3 is a China-based group 
attributed to China’s Ministry of State Security. It is responsible for campaigns like 
Operation Clandestine Fox and targets industries like aerospace and defense.");
INSERT INTO APT_GROUPS VALUES("APT30", null, "APT30 is a Chinese cyber espionage group, 
often targeting government and political institutions in Southeast Asia, with a focus on 
intelligence collection.");
INSERT INTO APT_GROUPS VALUES("APT31", "Zirconium", "Chinese-linked group targeting 
government and technology sectors. TTPs include: Use of novel malware families and 
custom-built tools. Exploitation of zero-day vulnerabilities in popular software. Advanced 
techniques for lateral movement and privilege escalation. Deployment of backdoors like SOGU 
and JNDI. Targeting of intellectual property and sensitive government information. 
Sophisticated methods for maintaining long-term persistence in compromised networks.");
INSERT INTO APT_GROUPS VALUES("APT32", "OceanLotus", "APT32 is a Vietnamese state-sponsored 
cyber espionage group known for targeting private industries and government organizations 
across Southeast Asia.");
INSERT INTO APT_GROUPS VALUES("APT33", "Elfin", "APT33 is an Iranian group focused on 
targeting the aviation and energy sectors, particularly in the US, Saudi Arabia, and South 
Korea.");
INSERT INTO APT_GROUPS VALUES("APT34", "OilRig", "An Iranian group focusing on Middle 
Eastern organizations, utilizing spear-phishing and public-facing application exploits, 
deploying malware such as TRIGONA and HELMINTH for persistence via web shells.");
INSERT INTO APT_GROUPS VALUES("APT35", "Charming Kitten", "An Iranian-linked group 
targeting government and defense sectors, using spear-phishing and social engineering, 
deploying custom malware like POWERSTATS and targeting nuclear and military entities.");
INSERT INTO APT_GROUPS VALUES("APT36", "Transparent Tribe", "Pakistan-linked group focusing 
on government and military targets. TTPs include: Spear-phishing campaigns with 
geopolitical themes. Use of malicious macro-enabled documents for initial compromise. 
Deployment of custom RATs like Crimson and BreachRAT. Extensive use of social engineering 
techniques. Targeting of defense and government organizations in South Asia. Advanced 
persistence mechanisms and data exfiltration methods.");
INSERT INTO APT_GROUPS VALUES("APT37", "Reaper", "APT37 is a North Korean cyber espionage 
group targeting South Korea and other regions, primarily focusing on government and defense 
entities.");
INSERT INTO APT_GROUPS VALUES("APT38", "Lazarus Subgroup", "APT38 is a North Korean group 
specialized in financially motivated attacks, known for targeting the SWIFT banking system, 
executing theft operations involving millions of dollars.");
INSERT INTO APT_GROUPS VALUES("APT39", "Chafer", "APT39 is an Iranian cyber espionage 
group, targeting telecommunications, travel, and other sectors to gather intelligence and 
personal data.");
INSERT INTO APT_GROUPS VALUES("APT40", "TEMP.Periscope", "A Chinese group targeting 
maritime industries through spear-phishing and watering hole attacks, deploying custom 
malware like Derusbi and Gh0st RAT to maintain long-term persistence and exfiltrate 
sensitive data.");
INSERT INTO APT_GROUPS VALUES("APT41", null, "APT41 is a Chinese-linked espionage and 
financially motivated group, known for supply chain attacks and exploiting vulnerabilities 
in software development processes.");
INSERT INTO APT_GROUPS VALUES("Aquatic Panda", null, "Aquatic Panda is a China-based group 
focused on intelligence collection and industrial espionage, primarily targeting 
telecommunications and technology sectors.");
INSERT INTO APT_GROUPS VALUES("Axiom", null, "Axiom is a suspected Chinese cyber espionage 
group, targeting aerospace, defense, government, and manufacturing sectors.");
INSERT INTO APT_GROUPS VALUES("BackdoorDiplomacy", null, "BackdoorDiplomacy is a cyber 
espionage group targeting Ministries of Foreign Affairs and telecommunications companies in 
Africa, Europe, the Middle East, and Asia.");
INSERT INTO APT_GROUPS VALUES("BITTER", null, "BITTER is a South Asian cyber espionage 
group targeting government, energy, and engineering sectors in Pakistan, China, Bangladesh, 
and Saudi Arabia.");
INSERT INTO APT_GROUPS VALUES("BlackOasis", null, "BlackOasis is a Middle Eastern group 
targeting prominent individuals like opposition activists and journalists, often associated 
with Gamma Group customers.");
INSERT INTO APT_GROUPS VALUES("BlackTech", null, "BlackTech is a suspected Chinese cyber 
espionage group targeting organizations across East Asia, particularly those in media and 
electronics manufacturing sectors.");
INSERT INTO APT_GROUPS VALUES("Blue Mockingbird", null, "Blue Mockingbird is a cluster of 
activity involving Monero cryptocurrency-mining payloads, first observed in December 
2019.");
INSERT INTO APT_GROUPS VALUES("BRONZE BUTLER", null, "BRONZE BUTLER is a Chinese cyber 
espionage group targeting Japanese organizations, particularly in government and 
biotechnology sectors.");
INSERT INTO APT_GROUPS VALUES("Carbanak", null, "Carbanak is a financially motivated group 
targeting financial institutions with spear-phishing campaigns followed by fraudulent 
banking operations.");
INSERT INTO APT_GROUPS VALUES("Chimera", null, "Chimera is a China-based threat group 
targeting the semiconductor industry and airline industry in Taiwan and beyond.");
INSERT INTO APT_GROUPS VALUES("Cinnamon Tempest", null, "Cinnamon Tempest is a China-based 
group deploying ransomware based on Babuk’s source code, targeting intellectual property 
theft rather than financial gain.");
INSERT INTO APT_GROUPS VALUES("Cleaver", null, "Cleaver is an Iranian group responsible for 
Operation Cleaver, targeting critical infrastructure across multiple countries.");
INSERT INTO APT_GROUPS VALUES("Cobalt Group", null, "Cobalt Group is a financially 
motivated threat group, targeting financial institutions globally through malware designed 
to manipulate ATMs and card processing systems.");
INSERT INTO APT_GROUPS VALUES("Confucius", null, "Confucius is a South Asian espionage 
group targeting military and government organizations, with overlapping tools and tactics 
with Patchwork.");
INSERT INTO APT_GROUPS VALUES("CopyKittens", null, "CopyKittens is an Iranian cyber 
espionage group active since 2013, targeting government and private sectors globally, 
including the US, Germany, and Israel.");
INSERT INTO APT_GROUPS VALUES("CURIUM", null, "CURIUM is an Iranian group that focuses on 
establishing long-term social engineering relationships before delivering malware.");
INSERT INTO APT_GROUPS VALUES("CyberAv3ngers", null, "CyberAv3ngers is an IRGC-affiliated 
group targeting Israel's critical infrastructure, operating since 2020.");
INSERT INTO APT_GROUPS VALUES("Dark Caracal", null, "Dark Caracal is a Lebanese group 
attributed to the General Directorate of General Security, active since at least 2012, 
conducting global cyber espionage operations.");
INSERT INTO APT_GROUPS VALUES("Darkhotel", null, "Darkhotel is a South Korean group 
targeting executives in East Asia, often via hotel networks.");
INSERT INTO APT_GROUPS VALUES("DarkHydrus", null, "DarkHydrus is a Middle Eastern group 
targeting government agencies and educational institutions using open-source tools.");
INSERT INTO APT_GROUPS VALUES("DarkVishnya", null, "DarkVishnya is a financially motivated 
actor targeting banks in Eastern Europe, often using physical devices for network access.");
INSERT INTO APT_GROUPS VALUES("Deep Panda", null, "Deep Panda is a Chinese group targeting 
industries like healthcare and telecommunications, linked to the Anthem intrusion.");
INSERT INTO APT_GROUPS VALUES("Dragonfly", "Energetic Bear", "Dragonfly is a Russian group 
targeting critical infrastructure sectors such as defense, energy, and aviation, often 
using supply chain attacks.");
INSERT INTO APT_GROUPS VALUES("DragonOK", null, "DragonOK is a Chinese group targeting 
Japanese organizations via phishing campaigns, deploying malware such as PlugX and 
PoisonIvy.");
INSERT INTO APT_GROUPS VALUES("Earth Lusca", null, "Earth Lusca is a China-based group 
targeting governments, media, and research organizations across Asia and Europe.");
INSERT INTO APT_GROUPS VALUES("Elderwood", null, "Elderwood is a Chinese group linked to 
the Operation Aurora attack on Google, targeting defense and human rights organizations.");
INSERT INTO APT_GROUPS VALUES("Ember Bear", null, "Ember Bear is a Russian group targeting 
Ukraine and Georgia, linked to the WhisperGate attacks.");
INSERT INTO APT_GROUPS VALUES("Equation", null, "Equation is a highly sophisticated group 
believed to be linked to the NSA, known for firmware-based attacks and advanced malware.");
INSERT INTO APT_GROUPS VALUES("Equation Group", null, "Believed to be linked to the NSA, 
this group is known for highly sophisticated operations targeting high-value entities 
worldwide. TTPs include exploiting zero-day vulnerabilities in firmware and hard drive 
controllers, using advanced malware such as EquationDrug (modular platform) and GrayFish 
(validator implant). Their persistence techniques survive system reinstalls, allowing them 
to target air-gapped networks effectively. They employ complex multi-stage attack chains 
along with advanced encryption methods for secure communications.");
INSERT INTO APT_GROUPS VALUES("Evilnum", null, "Evilnum is a financially motivated group 
active since at least 2018, targeting financial institutions.");
INSERT INTO APT_GROUPS VALUES("EXOTIC LILY", null, "EXOTIC LILY is a financially motivated 
group linked to Wizard Spider, deploying ransomware such as Conti.");
INSERT INTO APT_GROUPS VALUES("Ferocious Kitten", null, "Ferocious Kitten is an Iranian 
group targeting Persian-speaking individuals, often using custom malware to gather 
intelligence.");
INSERT INTO APT_GROUPS VALUES("FIN10", null, "FIN10 is a financially motivated group 
extorting North American organizations through data theft and ransomware.");
INSERT INTO APT_GROUPS VALUES("FIN11", null, "A financially motivated group linked to 
Eastern Europe, conducting large-scale phishing campaigns with malicious documents and 
malware like FRIENDSPEAK and MIXLABEL, focused on financial gain and evasion of 
detection.");
INSERT INTO APT_GROUPS VALUES("FIN13", null, "FIN13 is a Latin American financial cyber 
threat group targeting financial institutions for theft of intellectual property.");
INSERT INTO APT_GROUPS VALUES("FIN4", null, "FIN4 is a financial group focused on capturing 
email credentials in the financial market, particularly in the healthcare and 
pharmaceutical sectors.");
INSERT INTO APT_GROUPS VALUES("FIN5", null, "FIN5 is a financially motivated group 
targeting payment card data in the restaurant, gaming, and hotel industries, active since 
2008.");
INSERT INTO APT_GROUPS VALUES("FIN6", null, "FIN6 is a cybercrime group known for stealing 
payment card data from point-of-sale (PoS) systems in the hospitality and retail sectors.");
INSERT INTO APT_GROUPS VALUES("FIN7", null, "FIN7 is a financially motivated group 
targeting the retail, restaurant, and hospitality sectors, using phishing and malware such 
as Carbanak for payment card theft.");
INSERT INTO APT_GROUPS VALUES("FIN8", null, "FIN8 is a financially motivated group 
targeting PoS devices in hospitality, retail, and financial sectors, with ransomware and 
cryptocurrency mining malware.");
INSERT INTO APT_GROUPS VALUES("Fox Kitten", null, "Fox Kitten is an Iranian group targeting 
critical infrastructure sectors, including oil and gas, and government organizations in the 
Middle East.");
INSERT INTO APT_GROUPS VALUES("GALLIUM", null, "GALLIUM is a Chinese cyber espionage group 
targeting telecommunications and financial institutions, with a focus on the Operation Soft 
Cell campaign.");
INSERT INTO APT_GROUPS VALUES("Gallmaker", null, "Gallmaker is a cyber espionage group 
targeting defense and military sectors using fileless malware and leveraging legitimate 
tools for espionage operations.");
INSERT INTO APT_GROUPS VALUES("Gamaredon Group", null, "Gamaredon Group is a Russian threat 
group targeting Ukrainian government entities, using spear-phishing, VBA macros, and 
PowerShell for data exfiltration.");
INSERT INTO APT_GROUPS VALUES("GCMAN", null, "GCMAN is a group targeting banks for 
fraudulent transfers to e-currency services, often using sophisticated financial tools.");
INSERT INTO APT_GROUPS VALUES("GOLD SOUTHFIELD", null, "GOLD SOUTHFIELD is a financially 
motivated group operating the REvil Ransomware-as-a-Service (RaaS) platform, active since 
2018.");
INSERT INTO APT_GROUPS VALUES("Gorgon Group", null, "Gorgon Group is a Pakistan-based group 
targeting government organizations in the US, Russia, Spain, and the UK through criminal 
and espionage attacks.");
INSERT INTO APT_GROUPS VALUES("Group5", null, "Group5 is a suspected Iranian group 
targeting Syrian opposition via spear-phishing and watering hole attacks using RATs like 
njRAT and NanoCore.");
INSERT INTO APT_GROUPS VALUES("HAFNIUM", null, "HAFNIUM is a Chinese state-sponsored group 
targeting US entities across sectors like infectious disease research, law firms, and 
defense contractors.");
INSERT INTO APT_GROUPS VALUES("HEXANE", null, "HEXANE is a cyber espionage group targeting 
oil & gas, telecommunications, and ISPs in the Middle East and Africa, with tactics similar 
to APT33 and OilRig.");
INSERT INTO APT_GROUPS VALUES("Higaisa", null, "Higaisa is a suspected South Korean group 
targeting public organizations in North Korea, Japan, Russia, and other countries for 
espionage purposes.");
INSERT INTO APT_GROUPS VALUES("Inception", null, "Inception is a Russian cyber espionage 
group targeting industries worldwide, particularly government entities in Europe and 
Asia.");
INSERT INTO APT_GROUPS VALUES("IndigoZebra", null, "IndigoZebra is a Chinese group 
targeting Central Asian governments through sophisticated phishing and malware 
deployment.");
INSERT INTO APT_GROUPS VALUES("Indrik Spider", null, "Indrik Spider is a Russian group 
known for ransomware operations like BitPaymer and WastedLocker, targeting financial and 
technology sectors.");
INSERT INTO APT_GROUPS VALUES("Ke3chang", null, "Ke3chang is a Chinese cyber espionage 
group targeting diplomatic, military, and oil organizations, often using spear-phishing 
campaigns.");
INSERT INTO APT_GROUPS VALUES("Kimsuky", null, "Kimsuky is a North Korean group targeting 
think tanks, government organizations, and individuals involved in Korean Peninsula 
issues.");
INSERT INTO APT_GROUPS VALUES("LAPSUS$", null, "LAPSUS$ is a cybercriminal group active 
since 2021, specializing in large-scale social engineering and extortion campaigns against 
global organizations.");
INSERT INTO APT_GROUPS VALUES("Lazarus Group", null, "Lazarus Group is a North Korean group 
known for financial theft and espionage, deploying malware like HOPLIGHT and FALLCHILL 
against financial institutions and cryptocurrency exchanges.");
INSERT INTO APT_GROUPS VALUES("LazyScripter", null, "LazyScripter is a group targeting the 
airline industry using open-source toolsets for cyber espionage campaigns.");
INSERT INTO APT_GROUPS VALUES("Leafminer", null, "Leafminer is an Iranian group targeting 
Middle Eastern government organizations and businesses, active since 2017.");
INSERT INTO APT_GROUPS VALUES("Leviathan", "TEMP.Periscope", "Leviathan is a Chinese group
 targeting maritime industries and defense contractors for intellectual property theft 
 through spear-phishing and malware deployment.");
INSERT INTO APT_GROUPS VALUES("Lotus Blossom", null, "Lotus Blossom is a Chinese group 
targeting Southeast Asian government and military organizations, often using spear-phishing 
attacks.");
INSERT INTO APT_GROUPS VALUES("LuminousMoth", null, "LuminousMoth is a Chinese-speaking 
group targeting government entities in Myanmar, the Philippines, and Southeast Asia using 
custom malware.");
INSERT INTO APT_GROUPS VALUES("Machete", null, "Machete is a Spanish-speaking cyber 
espionage group targeting Latin American organizations with spear-phishing campaigns 
focusing on government and diplomatic entities.");
INSERT INTO APT_GROUPS VALUES("Magic Hound", null, "Magic Hound is an Iranian group 
conducting cyber espionage campaigns against government and military personnel in Europe, 
the US, and the Middle East.");
INSERT INTO APT_GROUPS VALUES("Malteiro", null, "Malteiro is a Brazilian financially 
motivated group targeting victims in Latin America with the Mispadu banking trojan 
distributed via Malware-as-a-Service.");
INSERT INTO APT_GROUPS VALUES("menuPass", null, "menuPass is a Chinese group active since 
2006, targeting industries like aerospace, government, and defense, often linked to the 
MSS.");
INSERT INTO APT_GROUPS VALUES("Metador", null, "Metador is a suspected cyber espionage 
group targeting telecommunication companies and ISPs in the Middle East and Africa.");
INSERT INTO APT_GROUPS VALUES("Moafee", null, "Moafee is a Chinese group targeting Japanese 
organizations with phishing and malware attacks, overlapping with the DragonOK group.");
INSERT INTO APT_GROUPS VALUES("Mofang", null, "Mofang is a Chinese group targeting critical 
infrastructure in Myanmar and other countries, using imitative tactics to compromise 
networks.");
INSERT INTO APT_GROUPS VALUES("Molerats", null, "Molerats is an Arabic-speaking group 
targeting Middle Eastern, European, and US organizations through politically motivated 
campaigns.");
INSERT INTO APT_GROUPS VALUES("Moses Staff", null, "Moses Staff is an Iranian group 
targeting Israeli companies, focused on leaking sensitive data without demanding a 
ransom.");
INSERT INTO APT_GROUPS VALUES("MoustachedBouncer", null, "MoustachedBouncer is a group 
targeting foreign embassies in Belarus, using espionage campaigns to collect sensitive 
diplomatic data.");
INSERT INTO APT_GROUPS VALUES("MuddyWater", null, "MuddyWater is an Iranian group targeting 
Middle Eastern and Central Asian organizations with spear-phishing attacks deploying 
malware like POWERSTATS.");
INSERT INTO APT_GROUPS VALUES("Mustang Panda", null, "Mustang Panda is a Chinese group 
targeting government entities, nonprofits, and religious organizations in the US, Europe, 
and Southeast Asia.");
INSERT INTO APT_GROUPS VALUES("Mustard Tempest", null, "Mustard Tempest is an initial 
access broker operating the SocGholish network since 2017, collaborating with Indrik Spider 
for additional malware deployment.");
INSERT INTO APT_GROUPS VALUES("Naikon", null, "Naikon is a Chinese cyber espionage group 
targeting Southeast Asian governments and international organizations like the UNDP.");
INSERT INTO APT_GROUPS VALUES("NEODYMIUM", null, "NEODYMIUM is a group active since 2016, 
targeting Turkish victims with campaigns linked to BlackOasis and PROMETHIUM.");
INSERT INTO APT_GROUPS VALUES("Nomadic Octopus", null, "Nomadic Octopus is a Russian group 
targeting Central Asian governments and diplomatic missions, using custom Android and 
Windows malware.");
INSERT INTO APT_GROUPS VALUES("OilRig", null, "OilRig is an Iranian group targeting Middle 
Eastern and international organizations through supply chain attacks and public-facing 
application exploits.");
INSERT INTO APT_GROUPS VALUES("Orangeworm", null, "Orangeworm is a group targeting 
healthcare organizations globally, using malware like Kwampirs for espionage and 
intellectual property theft.");
INSERT INTO APT_GROUPS VALUES("Patchwork", "Dropping Elephant", "Patchwork is a group 
linked to India, targeting diplomatic entities and think tanks through spear-phishing with 
malware like BADNEWS.");
INSERT INTO APT_GROUPS VALUES("PittyTiger", null, "PittyTiger is a Chinese group using 
various malware to maintain command and control, targeting global organizations.");
INSERT INTO APT_GROUPS VALUES("PLATINUM", null, "PLATINUM is an espionage group targeting 
South and Southeast Asian governments, active since at least 2009.");
INSERT INTO APT_GROUPS VALUES("POLONIUM", null, "POLONIUM is a Lebanese group targeting 
Israeli organizations, collaborating with Iranian actors for advanced espionage 
campaigns.");
INSERT INTO APT_GROUPS VALUES("Poseidon Group", null, "Poseidon Group is a 
Portuguese-speaking group using blackmail tactics, targeting companies for information 
theft and forcing them to contract Poseidon as a security firm.");
INSERT INTO APT_GROUPS VALUES("PROMETHIUM", null, "PROMETHIUM is an espionage group 
targeting Turkish organizations, operating globally with overlapping characteristics with 
NEODYMIUM.");
INSERT INTO APT_GROUPS VALUES("Putter Panda", null, "Putter Panda is a Chinese group linked 
to Unit 61486 of the PLA, targeting aerospace and defense sectors globally.");
INSERT INTO APT_GROUPS VALUES("Rancor", null, "Rancor is a group targeting Southeast Asian 
entities using politically motivated lures to deploy malicious documents.");
INSERT INTO APT_GROUPS VALUES("Rocke", null, "Rocke is a Chinese-speaking group focused on 
cryptojacking by leveraging victim systems to mine cryptocurrency, active since at least 
2018.");
INSERT INTO APT_GROUPS VALUES("RTM", null, "RTM is a Russian cybercriminal group targeting 
remote banking systems in Russia and neighboring countries with malware.");
INSERT INTO APT_GROUPS VALUES("Sandworm Team", null, "Sandworm Team is a Russian group 
targeting critical infrastructure, deploying destructive malware like BlackEnergy and 
Industroyer.");
INSERT INTO APT_GROUPS VALUES("Scarlet Mimic", null, "Scarlet Mimic is a Chinese-linked 
group targeting minority rights activists through espionage campaigns with custom 
malware.");
INSERT INTO APT_GROUPS VALUES("Scattered Spider", null, "Scattered Spider is an 
English-speaking cybercriminal group targeting telecommunications and technology companies, 
deploying ransomware for financial gain.");
INSERT INTO APT_GROUPS VALUES("SideCopy", null, "SideCopy is a Pakistani group targeting 
Indian and Afghani government personnel through spear-phishing campaigns mimicking 
Sidewinder tactics.");
INSERT INTO APT_GROUPS VALUES("Sidewinder", null, "Sidewinder is an Indian group targeting 
military and business entities across Asia, especially Pakistan and China, using advanced 
malware.");
INSERT INTO APT_GROUPS VALUES("Silence", null, "Silence is a financially motivated group 
targeting banks and ATMs, focused on fraudulent transfers using legitimate banking tools.");
INSERT INTO APT_GROUPS VALUES("Silent Librarian", null, "Silent Librarian is an Iranian 
group targeting universities and government agencies for intellectual property theft, 
linked to the Iranian Mabna Institute.");
INSERT INTO APT_GROUPS VALUES("SilverTerrier", null, "SilverTerrier is a Nigerian 
cybercriminal group targeting organizations in the technology and manufacturing sectors, 
known for using commodity malware.");
INSERT INTO APT_GROUPS VALUES("Sowbug", null, "Sowbug is a group targeting South American 
and Southeast Asian government entities through espionage campaigns focused on data 
exfiltration.");
INSERT INTO APT_GROUPS VALUES("Stealth Falcon", null, "Stealth Falcon is a UAE-linked group 
targeting Emirati journalists, activists, and dissidents through spyware campaigns.");
INSERT INTO APT_GROUPS VALUES("Strider", null, "Strider is a group targeting victims in 
Russia, China, Sweden, and Iran, using sophisticated espionage malware for long-term 
operations.");
INSERT INTO APT_GROUPS VALUES("Suckfly", null, "Suckfly is a Chinese group targeting 
government and private-sector organizations in Asia and North America, active since at 
least 2014.");
INSERT INTO APT_GROUPS VALUES("TA2541", null, "TA2541 is a cybercriminal group targeting 
aviation, aerospace, and defense industries using remote access trojans (RATs) and phishing 
campaigns.");
INSERT INTO APT_GROUPS VALUES("TA459", null, "TA459 is a Chinese group targeting Russian, 
Belarusian, and Mongolian organizations through espionage campaigns.");
INSERT INTO APT_GROUPS VALUES("TA505", null, "TA505 is a financially motivated group known 
for large-scale malspam campaigns, distributing malware like Clop ransomware and 
FlawedAmmyy RAT.");
INSERT INTO APT_GROUPS VALUES("TA551", null, "TA551 is a financially motivated group active 
since 2018, targeting organizations with email-based malware distribution campaigns.");
INSERT INTO APT_GROUPS VALUES("TeamTNT", null, "TeamTNT is a group targeting cloud and 
container environments to deploy cryptocurrency miners and perform data theft.");
INSERT INTO APT_GROUPS VALUES("TEMP.Veles", null, "TEMP.Veles is a Russian group targeting 
critical infrastructure, using the TRITON malware framework to manipulate industrial safety 
systems.");
INSERT INTO APT_GROUPS VALUES("The White Company", null, "The White Company is a likely 
state-sponsored group targeting Pakistani government and military organizations, active 
since 2017.");
INSERT INTO APT_GROUPS VALUES("Threat Group-1314", null, "Threat Group-1314 is an 
unattributed group using compromised credentials to access victims’ remote access 
infrastructure.");
INSERT INTO APT_GROUPS VALUES("Threat Group-3390", null, "Threat Group-3390 is a Chinese 
group targeting aerospace, government, and defense sectors through web compromises and 
malware.");
INSERT INTO APT_GROUPS VALUES("Thrip", null, "Thrip is a Chinese-linked group targeting 
satellite communications, defense contractors, and telecommunications companies.");
INSERT INTO APT_GROUPS VALUES("ToddyCat", null, "ToddyCat is a sophisticated group active 
since 2020, targeting government and military organizations across Europe and Asia using 
custom loaders and multi-stage malware.");
INSERT INTO APT_GROUPS VALUES("Tonto Team", null, "Tonto Team is a Chinese group targeting 
government and military organizations in South Korea, Japan, and the US using 
spear-phishing and espionage malware.");
INSERT INTO APT_GROUPS VALUES("Transparent Tribe", null, "Transparent Tribe is a 
Pakistan-based group targeting Indian and Afghan defense and government organizations 
through spear-phishing and remote access trojans.");
INSERT INTO APT_GROUPS VALUES("Tropic Trooper", null, "Tropic Trooper is a group targeting 
government, healthcare, and high-tech industries in Taiwan and the Philippines using custom 
malware.");
INSERT INTO APT_GROUPS VALUES("Turla", "Snake", "Turla is a Russian group targeting 
government and diplomatic entities worldwide, using sophisticated malware like Snake and 
Carbon.");
INSERT INTO APT_GROUPS VALUES("UNC788", null, "UNC788 is an Iranian group targeting 
individuals in the Middle East using spear-phishing and malware deployment.");
INSERT INTO APT_GROUPS VALUES("Volatile Cedar", null, "Volatile Cedar is a Lebanese group 
targeting companies and institutions worldwide, focusing on espionage and political 
interests.");
INSERT INTO APT_GROUPS VALUES("Volt Typhoon", null, "Volt Typhoon is a Chinese 
state-sponsored group targeting critical infrastructure in the US, focusing on espionage 
and information gathering.");
INSERT INTO APT_GROUPS VALUES("Whitefly", null, "Whitefly is a Chinese group targeting 
Singapore-based organizations, primarily interested in stealing sensitive information, such 
as healthcare data.");
INSERT INTO APT_GROUPS VALUES("Windigo", null, "Windigo is a group compromising Linux and 
Unix servers since 2011, using the Ebury SSH backdoor to create a spam botnet.");
INSERT INTO APT_GROUPS VALUES("Windshift", null, "Windshift is a group targeting government 
departments and critical infrastructure in the Middle East for surveillance purposes.");
INSERT INTO APT_GROUPS VALUES("Winnti Group", null, "Winnti Group is a Chinese group 
targeting gaming and software companies through supply chain attacks, using malware like 
PlugX and ShadowPad.");
INSERT INTO APT_GROUPS VALUES("WIRTE", null, "WIRTE is a group targeting government and 
diplomatic organizations in the Middle East and Europe, using malware to exfiltrate 
sensitive data.");
INSERT INTO APT_GROUPS VALUES("Wizard Spider", null, "Wizard Spider is a Russia-based group 
known for operating TrickBot malware and deploying Ryuk and Conti ransomware in high-value 
campaigns.");
INSERT INTO APT_GROUPS VALUES("ZIRCONIUM", null, "ZIRCONIUM is a Chinese group targeting 
individuals involved in US presidential elections and international affairs, active since 
at least 2017.");
...
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-20269", "Dragonfly", "0.68", "Dragonfly's 
focus on targeting critical infrastructure sectors and their use of supply chain attacks 
might lead them to exploit this vulnerability, especially since it affects network security 
devices, which could provide a foothold in their desired sectors; however, the requirement 
for valid credentials, including a second factor if MFA is configured, might reduce the 
appeal of this vulnerability to the group.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-20256", "Dragonfly", "0.72", "Given 
Dragonfly's focus on targeting critical infrastructure sectors and their use of supply 
chain attacks, the likelihood of them exploiting this vulnerability is high. However, the 
vulnerability requires a specific configuration to be exploited, which might limit its 
appeal to the group, hence a score below 1.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-20247", "Dragonfly", "0.68", "Given 
Dragonfly's focus on supply chain attacks and targeting critical infrastructure, the 
likelihood of exploiting a Cisco ASA/FTD vulnerability is moderate, as these devices are 
commonly used in such sectors. However, the vulnerability requires authentication, which 
might not align with Dragonfly's typical tactics of initial access through supply chain 
attacks or other means.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-20200", "Dragonfly", "0.62", "Dragonfly's 
focus on critical infrastructure sectors and supply chain attacks increases the likelihood 
of exploiting this vulnerability, as it affects network management services in sectors like 
defense and energy. However, the requirement for authentication or knowledge of SNMP 
community strings reduces the likelihood of exploitation, as Dragonfly's typical tactics 
involve more stealthy and opportunistic approaches.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-20095", "Dragonfly", "0.72", "Dragonfly's 
focus on supply chain attacks and targeting critical infrastructure sectors increases the 
likelihood of exploiting this vulnerability, given the potential impact on defense and 
energy sectors. However, the vulnerability's relatively simple denial-of-service nature and 
lack of clear lateral movement or data exfiltration potential may limit its appeal to a 
sophisticated group like Dragonfly.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-20015", "Dragonfly", "0.72", "Dragonfly's 
focus on critical infrastructure sectors and use of supply chain attacks align with the 
potential impact of exploiting a vulnerability in network security appliances and data 
center equipment, making them likely to exploit this vulnerability if they have the 
necessary access. However, the vulnerability requires local authentication, which may limit 
its appeal to a group that often relies on more remote and stealthy tactics.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-20934", "Dragonfly", "0.20", "The 
vulnerability is an Android-specific local escalation of privilege issue, which is unlikely 
to be relevant to Dragonfly's typical targets of critical infrastructure sectors. 
Dragonfly's TTPs typically involve supply chain attacks, making it less likely they would 
focus on exploiting this specific Android vulnerability.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2018-0284", "Dragonfly", "0.67", "Dragonfly's focus 
on critical infrastructure sectors and use of supply chain attacks make it plausible they 
would exploit a vulnerability allowing them to establish an interactive session with 
elevated privileges. However, the requirement for an authenticated attacker and the 
relatively old age of the vulnerability (2018) slightly reduce the likelihood of 
exploitation.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2014-7999", "Dragonfly", "0.23", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors does not directly 
align with exploiting a 9-year-old firmware vulnerability in Cisco-Meraki devices, and the 
requirement for remote authentication reduces the vulnerability's appeal for their typical 
tactics. However, it's still possible they might leverage this vulnerability in a specific, 
targeted operation.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2014-7993", "Dragonfly", "0.67", "Dragonfly's focus 
on critical infrastructure sectors, including energy and aviation, aligns with the p
otential targets of Cisco-Meraki devices, making exploitation plausible. However, the 
vulnerability's age (2014) and the group's preference for supply chain attacks may decrease 
the likelihood of exploiting this specific vulnerability.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2014-7994", "Dragonfly", "0.30", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors suggests they may not 
prioritize exploiting a 9-year-old vulnerability in Cisco-Meraki devices, which may not be 
prevalent in their target sectors; however, their technical sophistication and adaptability 
cannot be entirely ruled out.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2016-6473", "Dragonfly", "0.40", "Dragonfly's 
primary focus on supply chain attacks and targeting critical infrastructure sectors such as 
defense, energy, and aviation, suggests they might not prioritize exploiting a 7-year-old 
network vulnerability like CVE-2016-6473, which is relatively old and has likely been 
patched in most environments, reducing its value as a viable attack vector. However, the 
vulnerability's impact on network availability and potential for lateral movement might 
still make it an attractive option for Dragonfly, albeit a less preferred one.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2017-6606", "Dragonfly", "0.43", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors does not directly 
align with exploiting a publicly disclosed vulnerability in Cisco IOS XE Software, which 
may not be a typical entry point for their operations. However, their interest in critical 
infrastructure sectors such as energy and aviation may lead them to explore vulnerabilities 
in network equipment, making exploitation possible but not highly likely.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2017-3803", "Dragonfly", "0.22", "Dragonfly's 
primary tactics involve targeting high-value critical infrastructure through supply chain 
attacks, often using sophisticated social engineering and zero-day exploits. Given the 
relatively low-impact partial denial of service nature of this vulnerability and the 
requirement for adjacency to the vulnerable switch, it's unlikely to align with Dragonfly's 
typical objectives and methods.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2016-1425", "Dragonfly", "0.40", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors does not strongly 
align with exploiting a network device vulnerability like CVE-2016-1425, which is more 
related to network disruption. However, their general interest in disrupting critical 
infrastructure sectors gives them some motivation to exploit this vulnerability.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2012-2697", "Dragonfly", "0.14", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors suggests they 
prioritize high-impact exploits, whereas CVE-2012-2697 is a relatively low-severity, local 
DoS vulnerability with limited potential for lateral movement or significant disruption. 
Additionally, the vulnerability's age and limited scope make it an unlikely candidate for 
exploitation by a sophisticated group like Dragonfly.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2012-3440", "Dragonfly", "0.20", "The vulnerability 
is an older, local privilege escalation issue that may not be as appealing to Dragonfly, 
who primarily targets high-impact supply chain attacks, and may not be relevant to their 
typical TTPs. Additionally, the vulnerability requires an existing foothold on a RHEL 5 
system, which may not align with their typical attack vectors.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2010-0727", "Dragonfly", "0.15", "Dragonfly's TTPs 
focus on supply chain attacks and targeting critical infrastructure sectors, but there is 
no indication they specifically target Linux kernel vulnerabilities or exploit local 
denial-of-service bugs, making it unlikely they would prioritize CVE-2010-0727. The 
vulnerability's age and relatively low impact also suggest it's not a prime target for 
this APT group.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2015-7833", "Dragonfly", "0.17", "Dragonfly's 
primary focus on supply chain attacks and targeting critical infrastructure sectors makes 
it unlikely for them to exploit a relatively old Linux kernel vulnerability that requires 
physical proximity to the target system. The vulnerability's local exploitation vector and 
lack of relevance to their typical TTPs further reduce the likelihood of exploitation.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2020-7337", "Dragonfly", "0.72", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors aligns with the 
potential for exploiting vulnerabilities in security software like McAfee VirusScan 
Enterprise, making it a plausible target. However, the vulnerability requires local 
administrator access, which might limit its appeal to Dragonfly, given their preference for 
more stealthy and scalable exploitation methods.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2009-5118", "Dragonfly", "0.30", "Dragonfly's 
primary focus on supply chain attacks and targeting critical infrastructure sectors using 
more sophisticated methods makes it less likely for them to exploit a 14-year-old 
vulnerability like CVE-2009-5118, which requires local access and may not be as effective 
in their typical attack scenarios. However, the group's adaptability and willingness to use 
various tactics means they may still consider using this vulnerability in specific 
situations.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2007-2152", "Dragonfly", "0.20", "The vulnerability 
is an older, user-assisted remote attack that requires a specific version of McAfee 
VirusScan Enterprise, making it less likely to be exploited by Dragonfly, who tend to use 
more sophisticated supply chain attacks. Additionally, the group's focus on critical 
infrastructure sectors may not align with exploiting a relatively outdated vulnerability in 
an antivirus software.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-0101", "Dragonfly", "0.42", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors does not directly 
align with exploiting a vulnerability in a specific network scanning tool like Nessus, 
making it less likely for them to prioritize this vulnerability. However, their interest in 
escalating privileges in critical systems keeps the possibility open, albeit with 
relatively low probability.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2021-20135", "Dragonfly", "0.42", "Dragonfly's 
typical modus operandi involves targeting critical infrastructure sectors through supply 
chain attacks, and their tactics often rely on exploiting vulnerabilities in software used 
by their targets. While Nessus is a vulnerability scanner used in many industries, the 
specific vulnerability in question (CVE-2021-20135) is a local privilege escalation issue 
that may not be directly relevant to Dragonfly's typical attack vectors.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2020-5765", "Dragonfly", "0.62", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors increases the 
likelihood of exploiting a vulnerability in a widely-used security scanner like Nessus, but 
the requirement for authentication and the relatively low-impact nature of a stored XSS 
vulnerability make it less desirable compared to more impactful exploits.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2024-23675", "Dragonfly", "0.38", "Dragonfly's 
primary focus on supply chain attacks and targeting defense, energy, and aviation sectors 
may not directly align with exploiting a vulnerability in a logging and monitoring tool 
like Splunk, making it less likely for them to prioritize this vulnerability. However, 
their adaptability and past exploitation of various vulnerabilities still leave a 
possibility for them to leverage this vulnerability in a targeted attack.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2024-23676", "Dragonfly", "0.22", "Dragonfly's 
typical TTPs involve supply chain attacks, which don't align closely with exploiting a 
vulnerability like CVE-2024-23676 that requires user interaction and specific access to 
Splunk instances. Given their focus on high-impact sectors and tactics, exploiting this 
vulnerability seems unlikely to be a priority for the group.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-40593", "Dragonfly", "0.30", "Dragonfly's 
focus on supply chain attacks and critical infrastructure sectors doesn't directly align 
with the exploitation of a denial-of-service vulnerability in Splunk Enterprise, a security 
monitoring platform. While possible, it's unlikely they would prioritize this vulnerability 
over others that offer more strategic value or direct access to their target sectors.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-40592", "Dragonfly", "0.60", "Dragonfly's 
focus on critical infrastructure sectors and supply chain attacks may lead them to exploit 
vulnerabilities in widely used enterprise software like Splunk, but their typical modus 
operandi involves more targeted and sophisticated attacks, making it less likely for them 
to prioritize a reflected XSS vulnerability. However, the potential for arbitrary command 
execution on a critical platform like Splunk might still make it an attractive target, 
hence the moderate score.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2013-1935", "Dragonfly", "0.30", "The likelihood of 
Dragonfly exploiting this vulnerability is low as it is a relatively old vulnerability 
(CVE-2013-1935) and the group's TTPs focus more on supply chain attacks, which may not 
align with exploiting a specific kernel vulnerability. However, given their targeting of 
critical infrastructure sectors, it's possible they may still exploit it if they can 
leverage it to gain access to a specific system or network.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2013-2224", "Dragonfly", "0.20", "Although 
Dragonfly is known to target critical infrastructure, the vulnerability in question is an 
old local privilege escalation vulnerability on a specific Linux kernel version, and their 
typical modus operandi involves supply chain attacks rather than exploiting old local 
vulnerabilities, making it less likely for them to exploit this vulnerability. 
Additionally, the vulnerability's requirement for local access and specific system 
configuration reduces its appeal for a group that typically conducts targeted attacks on a 
larger scale.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2013-2188", "Dragonfly", "0.17", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors does not align with 
the exploitation of a 10-year-old local privilege escalation vulnerability in a Linux 
kernel, making it unlikely for them to exploit this vulnerability. Additionally, the 
vulnerability requires local access to a read-only filesystem, which limits its utility for 
a group that typically engages in more sophisticated and strategic attacks.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2023-47804", "Dragonfly", "0.62", "I've assigned a 
moderate likelihood score as Dragonfly's TTPs involve supply chain attacks and exploiting 
vulnerabilities in software used by their targeted sectors. While CVE-2023-47804 affects 
Apache OpenOffice, which might be used by some organizations in critical infrastructure s
ectors, it is not a typical attack vector for Dragonfly, and the vulnerability's complexity 
and specific requirements might limit its appeal to the group.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2022-37401", "Dragonfly", "0.30", "Dragonfly's 
primary focus on critical infrastructure sectors and supply chain attacks suggest that 
they may not prioritize exploiting a vulnerability in Apache OpenOffice, which is not 
typically a critical component in their target sectors. However, the group's use of various 
tactics and methods to gain access to sensitive information makes it possible that they 
might still exploit this vulnerability as a secondary or opportunistic attack vector.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2021-33035", "Dragonfly", "0.30", "The likelihood 
of Dragonfly exploiting this vulnerability is low due to their focus on supply chain 
attacks and targeting critical infrastructure sectors, which does not typically involve 
exploiting vulnerabilities in office software like Apache OpenOffice. Additionally, the 
vulnerability's requirement of a 'carefully crafted document' to overflow the allocated s
pace suggests a relatively complex and targeted attack, which may not align with 
Dragonfly's typical tactics.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2020-13958", "Dragonfly", "0.42", "The likelihood 
of Dragonfly exploiting CVE-2020-13958 is moderate to low due to the vulnerability's 
reliance on a specific application (Apache OpenOffice) and the group's historical focus on 
supply chain attacks targeting critical infrastructure sectors. While it's possible 
Dragonfly could adapt this vulnerability to suit their needs, their typical TTPs and 
exploitation methods make it less likely they would prioritize this specific 
vulnerability.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2017-12607", "Dragonfly", "0.30", "Given 
Dragonfly's focus on supply chain attacks targeting critical infrastructure sectors, and 
their typical exploitation methods, it is unlikely that they would exploit a relatively old 
vulnerability in OpenOffice's PPT file parser, which doesn't seem to align with their 
typical tactics. The vulnerability's age and limited scope also decrease the likelihood of 
Dragonfly using it for their attacks.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2017-8543", "Dragonfly", "0.40", "Although 
Dragonfly is known for using supply chain attacks, which can involve exploiting 
vulnerabilities in software, the vulnerability in question (CVE-2017-8543) is specifically 
related to Windows Search and may not be directly relevant to their typical targets in 
critical infrastructure sectors. Additionally, the vulnerability is over 5 years old, and 
it is likely that many organizations have already patched it, reducing its attractiveness 
to the APT group.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2014-0301", "Dragonfly", "0.40", "Dragonfly's 
typical focus on supply chain attacks and targeting critical infrastructure sectors makes 
it less likely for them to exploit a relatively old vulnerability in a Windows component 
like DirectShow, but it's still possible they might use it in a broader phishing or 
spear-phishing campaign to gain initial access.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2014-0323", "Dragonfly", "0.23", "Dragonfly's 
primary focus on supply chain attacks and targeting critical infrastructure sectors 
suggests they may not prioritize exploiting a local vulnerability like CVE-2014-0323, which 
requires an attacker to already have a presence on the system. Additionally, the 
vulnerability's age and potential for detection due to system hangs or crashes may further 
reduce its appeal to this APT group.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2014-0315", "Dragonfly", "0.17", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors suggests they prefer 
more sophisticated and stealthy methods, making the exploitation of a relatively old and 
local vulnerability like CVE-2014-0315 less likely. Additionally, the vulnerability 
requires a Trojan horse cmd.exe file to be present in the current working directory, which 
may not align with Dragonfly's typical modus operandi.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2013-5058", "Dragonfly", "0.20", "Dragonfly's focus 
on supply chain attacks and targeting critical infrastructure sectors suggests that they 
may not prioritize exploiting local privilege escalation vulnerabilities like 
CVE-2013-5058, which would require them to already have a foothold on the target system. 
Additionally, the vulnerability's age and the fact that it has likely been patched in most 
environments further reduces the likelihood of Dragonfly exploiting it.");
INSERT INTO APT_CVE_SCORING VALUES("CVE-2013-5056", "Dragonfly", "0.21", "Given Dragonfly's 
focus on supply chain attacks and targeting critical infrastructure, a client-side 
vulnerability like CVE-2013-5056, which requires user interaction with a crafted website, 
is less likely to align with their typical TTPs. Additionally, the age of the vulnerability 
(CVE-2013-5056) makes it less likely to be exploited by a sophisticated group like 
Dragonfly, as it's likely been patched in their target environments.");
